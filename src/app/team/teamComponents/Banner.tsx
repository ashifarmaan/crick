            ...
            <div className="rounded-lg bg-[#ffffff] p-4 mb-4">
                <Link href="#">
                    <div className="flex items-center gap-2 mb-2">
                        <Image src={teamDetails?.logo_url} className="h-[30px]" width={30} height={30} alt={teamDetails?.alt_name}/>
                        <h3 className="text-1xl font-semibold ">{teamDetails?.title} Team</h3>
                    </div>
                </Link>
