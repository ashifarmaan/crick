...
//  const sliderRef = useRef<HTMLDivElement>(null);
  ...
  let images = [];
  if(seriesData){
    images = seriesData.map((item: any) => ({
    ...
    let backUrl = '';
    if(result?.next != null) {
     nextUrl = "/series/"+urlStringEncode(result?.next?.title+"-"+result?.next?.season)+"/"+result?.next?.cid;
    }
                        ...
                        <div className="hidden md:flex flex-grow items-center justify-between px-6">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    {seriesInfo.game_format} - {seriesInfo.total_matches} Matches - {seriesInfo.total_teams} Teams | {format(new Date(seriesInfo.datestart), "dd MMMM")} to {format(new Date(seriesInfo.dateend), "dd MMMM")}
                                    </p>
