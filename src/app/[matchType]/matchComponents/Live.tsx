...
import { PlayerStats } from "@/controller/matchInfoController";
...
Live) {
  ...
  const [allCommentries, setAllCommentries] = useState(
    [...matchData?.live?.commentaries]?.reverse()
  );
  ...
  // const playerStats =  PlayerStats(634,"odi","bowling");
